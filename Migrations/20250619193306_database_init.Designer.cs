...
namespace WebApp.Migrations
{
    ...
    [Migration("20250619193306_database_init")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebApp.Entities.ReminderNotifications", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("WebApp.Entities.User", b =>
                {
                    ...
                    b.Property<int?>("ReminderNotificationsId")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("ReminderNotificationsId");
            ...
            modelBuilder.Entity("WebApp.Entities.User", b =>
                {
                    b.HasOne("WebApp.Entities.ReminderNotifications", "ReminderNotifications")
                        .WithMany()
                        .HasForeignKey("ReminderNotificationsId");
