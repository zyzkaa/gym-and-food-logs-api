        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReminderNotificationsId = table.Column<int>(type: "INTEGER", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Users", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Users_ReminderNotifications_ReminderNotificationsId",
                        column: x => x.ReminderNotificationsId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OriginalMealID = table.Column<int>(type: "INTEGER", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Meals_Meals_OriginalMealID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Meals_EditorID",
                table: "Meals",
                column: "EditorID");

            migrationBuilder.CreateIndex(
                name: "IX_Meals_IsShared",
                table: "Meals",
                column: "IsShared");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Users_ReminderNotificationsId",
                table: "Users",
                column: "ReminderNotificationsId");
